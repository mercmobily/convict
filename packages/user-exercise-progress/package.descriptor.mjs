export default Object.freeze({
  packageVersion: 1,
  packageId: "@local/user-exercise-progress",
  version: "0.1.0",
  kind: "runtime",
  description: "App-local CRUD package (user-exercise-progress).",
  dependsOn: [
    "@jskit-ai/auth-core",
    "@jskit-ai/crud-core",
  ...
  runtime: {
    server: {
      providers: [
        {
          entrypoint: "src/server/UserExerciseProgressProvider.js",
  ...
  metadata: {
    ...
    apiSummary: {
      ...
      containerTokens: {
        server: [
          "repository.user_exercise_progress",
