export default Object.freeze({
  packageVersion: 1,
  packageId: "@local/instance-program-entries",
  version: "0.1.0",
  kind: "runtime",
  description: "App-local CRUD package (instance-program-entries).",
  dependsOn: [
    "@jskit-ai/auth-core",
    "@jskit-ai/crud-core",
  ...
  runtime: {
    server: {
      providers: [
        {
          entrypoint: "src/server/InstanceProgramEntriesProvider.js",
  ...
  metadata: {
    ...
    apiSummary: {
      ...
      containerTokens: {
        server: [
          "repository.instance_program_entries",
