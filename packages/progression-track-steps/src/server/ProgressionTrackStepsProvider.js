...
const CRUD_MODULE_CONFIG = Object.freeze({
  namespace: "progression_track_steps",
  surface: "app",
  ownershipFilter: "public",
  relativePath: "/progression-track-steps"
});
...
function resolveCrudPolicyFromApp(app) {
  return resolveCrudSurfacePolicyFromAppConfig(CRUD_MODULE_CONFIG, resolveAppConfig(app), {
    context: "ProgressionTrackStepsProvider"
  });
}

class ProgressionTrackStepsProvider {
  static id = "crud.progression_track_steps";
  ...
  register(app) {
    ...
    app.singleton("repository.progression_track_steps", (scope) => {
    ...
    app.service(
      ...
      (scope) => {
        return createService({
          progressionTrackStepsRepository: scope.make("repository.progression_track_steps")
        });
      },
      {
    ...
    app.actions(
      withActionDefaults(
        ...
        }),
        {
          domain: "crud",
          dependencies: {
            progressionTrackStepsService: "crud.progression_track_steps"
          }
        }
      )
    );
...
export { ProgressionTrackStepsProvider };
