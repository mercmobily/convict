...
const actionPermissions = Object.freeze({
  list: "crud.workout_occurrences.list",
  view: "crud.workout_occurrences.view",
  create: "crud.workout_occurrences.create",
  update: "crud.workout_occurrences.update",
  delete: "crud.workout_occurrences.delete"
});
