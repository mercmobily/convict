...
const CRUD_MODULE_CONFIG = Object.freeze({
  ...
  relativePath: "/exercise-categories"
});
...
function resolveCrudPolicyFromApp(app) {
  return resolveCrudSurfacePolicyFromAppConfig(CRUD_MODULE_CONFIG, resolveAppConfig(app), {
    context: "ExerciseCategoriesProvider"
  });
}

class ExerciseCategoriesProvider {
  static id = "crud.exercise_categories";
  ...
  register(app) {
    ...
    app.singleton("repository.exercise_categories", (scope) => {
    ...
    app.service(
      "crud.exercise_categories",
      (scope) => {
        return createService({
          exerciseCategoriesRepository: scope.make("repository.exercise_categories")
        });
      },
      {
    ...
    app.actions(
      withActionDefaults(
        ...
        }),
        {
          domain: "crud",
          dependencies: {
            exerciseCategoriesService: "crud.exercise_categories"
          }
        }
      )
    );
...
export { ExerciseCategoriesProvider };
