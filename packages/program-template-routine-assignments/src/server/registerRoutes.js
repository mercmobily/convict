...
function registerRoutes(
  ...
  router.register(
    ...
    async function (request, reply) {
      ...
      const response = await request.executeAction({
        actionId: "crud.program_template_routine_assignments.list",
        input: listInput
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_template_routine_assignments.view",
        input: {
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_template_routine_assignments.create",
        input: {
          ...(request.input.body || {})
        }
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_template_routine_assignments.update",
        input: {
          recordId: request.input.params.recordId,
          ...(request.input.body || {})
        }
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_template_routine_assignments.delete",
        input: {
          recordId: request.input.params.recordId
        }
      });
