...
function registerRoutes(
  ...
  router.register(
    ...
    async function (request, reply) {
      ...
      const response = await request.executeAction({
        actionId: "crud.workout_set_logs.list",
        input: listInput
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.workout_set_logs.view",
        input: {
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.workout_set_logs.create",
        input: {
          ...(request.input.body || {})
        }
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.workout_set_logs.update",
        input: {
          recordId: request.input.params.recordId,
          ...(request.input.body || {})
        }
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.workout_set_logs.delete",
        input: {
          recordId: request.input.params.recordId
        }
      });
