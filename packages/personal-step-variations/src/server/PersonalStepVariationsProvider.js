...
const CRUD_MODULE_CONFIG = Object.freeze({
  ...
  relativePath: "/personal-step-variations"
});
...
function resolveCrudPolicyFromApp(app) {
  return resolveCrudSurfacePolicyFromAppConfig(CRUD_MODULE_CONFIG, resolveAppConfig(app), {
    context: "PersonalStepVariationsProvider"
  });
}

class PersonalStepVariationsProvider {
  static id = "crud.personal_step_variations";
  ...
  register(app) {
    ...
    app.singleton("repository.personal_step_variations", (scope) => {
    ...
    app.service(
      ...
      (scope) => {
        return createService({
          personalStepVariationsRepository: scope.make("repository.personal_step_variations")
        });
      },
      {
    ...
    app.actions(
      withActionDefaults(
        ...
        }),
        {
          domain: "crud",
          dependencies: {
            personalStepVariationsService: "crud.personal_step_variations"
          }
        }
      )
    );
...
export { PersonalStepVariationsProvider };
