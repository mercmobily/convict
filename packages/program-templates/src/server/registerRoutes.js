...
function registerRoutes(
  ...
  router.register(
    ...
    async function (request, reply) {
      ...
      const response = await request.executeAction({
        actionId: "crud.program_templates.list",
        input: listInput
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_templates.view",
        input: {
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_templates.create",
        input: {
          ...(request.input.body || {})
        }
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_templates.update",
        input: {
          recordId: request.input.params.recordId,
          ...(request.input.body || {})
        }
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_templates.delete",
        input: {
          recordId: request.input.params.recordId
        }
      });
