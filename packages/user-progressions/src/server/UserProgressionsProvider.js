...
const CRUD_MODULE_CONFIG = Object.freeze({
  ...
  relativePath: "/user-progressions"
});
...
function resolveCrudPolicyFromApp(app) {
  return resolveCrudSurfacePolicyFromAppConfig(CRUD_MODULE_CONFIG, resolveAppConfig(app), {
    context: "UserProgressionsProvider"
  });
}

class UserProgressionsProvider {
  static id = "crud.user_progressions";
  ...
  register(app) {
    ...
    app.singleton("repository.user_progressions", (scope) => {
    ...
    app.actions(
      withActionDefaults(
        ...
        }),
        {
          domain: "crud",
          dependencies: {
            userProgressionsService: "crud.user_progressions"
          }
        }
      )
    );
