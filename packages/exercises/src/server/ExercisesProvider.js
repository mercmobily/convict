...
class ExercisesProvider {
  ...
  register(app) {
    ...
    app.singleton("repository.exercises", (scope) => {
    ...
    app.service(
      ...
      (scope) => {
        return createService({
          exercisesRepository: scope.make("repository.exercises")
        });
      },
      {
    ...
    app.actions(
      withActionDefaults(
        ...
        }),
        {
          domain: "crud",
          dependencies: {
            exercisesService: "crud.exercises"
          }
        }
      )
    );
