...
const CRUD_MODULE_CONFIG = Object.freeze({
  ...
  relativePath: "/progression-entries"
});
...
function resolveCrudPolicyFromApp(app) {
  return resolveCrudSurfacePolicyFromAppConfig(CRUD_MODULE_CONFIG, resolveAppConfig(app), {
    context: "ProgressionEntriesProvider"
  });
}

class ProgressionEntriesProvider {
  static id = "crud.progression_entries";
  ...
  register(app) {
    ...
    app.singleton("repository.progression_entries", (scope) => {
    ...
    app.service(
      ...
      (scope) => {
        return createService({
          progressionEntriesRepository: scope.make("repository.progression_entries")
        });
      },
      {
    ...
    app.actions(
      withActionDefaults(
        ...
        }),
        {
          domain: "crud",
          dependencies: {
            progressionEntriesService: "crud.progression_entries"
          }
        }
      )
    );
...
export { ProgressionEntriesProvider };
