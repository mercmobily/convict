...
const resource = defineCrudResource({
  namespace: "program_routine_entries",
  ...
  programRoutineId: {
    ...
    required: true,
    search: true,
    relation: { kind: "lookup", namespace: "program-routines", valueKey: "id" },
    belongsTo: "programRoutines",
    as: "programRoutine",
  ...
  searchSchema: {
    ...
    programRoutineId: { type: "id", actualField: "program_routine_id", filterOperator: "=" },
    programRoutineIds: { type: "array", actualField: "program_routine_id", filterOperator: "in" },
