...
const CRUD_MODULE_CONFIG = Object.freeze({
  ...
  relativePath: "/program-routine-entries"
});
...
function resolveCrudPolicyFromApp(app) {
  return resolveCrudSurfacePolicyFromAppConfig(CRUD_MODULE_CONFIG, resolveAppConfig(app), {
    context: "ProgramRoutineEntriesProvider"
  });
}

class ProgramRoutineEntriesProvider {
  static id = "crud.program_routine_entries";
  ...
  register(app) {
    ...
    app.singleton("repository.program_routine_entries", (scope) => {
    ...
    app.actions(
      withActionDefaults(
        ...
        }),
        {
          domain: "crud",
          dependencies: {
            programRoutineEntriesService: "crud.program_routine_entries"
          }
        }
      )
    );
