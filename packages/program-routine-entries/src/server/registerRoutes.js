...
function registerRoutes(
  ...
  router.register(
    ...
    async function (request, reply) {
      ...
      const response = await request.executeAction({
        actionId: "crud.program_routine_entries.list",
        input: listInput
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_routine_entries.view",
        input: {
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_routine_entries.create",
        input: {
          ...(request.input.body || {})
        }
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_routine_entries.update",
        input: {
          recordId: request.input.params.recordId,
          ...(request.input.body || {})
        }
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.program_routine_entries.delete",
        input: {
          recordId: request.input.params.recordId
        }
      });
