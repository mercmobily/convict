...
const CRUD_MODULE_CONFIG = Object.freeze({
  namespace: "program_collections",
  surface: "app",
  ownershipFilter: "public",
  relativePath: "/program-collections"
});
...
function resolveCrudPolicyFromApp(app) {
  return resolveCrudSurfacePolicyFromAppConfig(CRUD_MODULE_CONFIG, resolveAppConfig(app), {
    context: "ProgramCollectionsProvider"
  });
}

class ProgramCollectionsProvider {
  static id = "crud.program_collections";
  ...
  register(app) {
    ...
    app.singleton("repository.program_collections", (scope) => {
    ...
    app.service(
      ...
      (scope) => {
        return createService({
          programCollectionsRepository: scope.make("repository.program_collections")
        });
      },
      {
    ...
    app.actions(
      withActionDefaults(
        ...
        }),
        {
          domain: "crud",
          dependencies: {
            programCollectionsService: "crud.program_collections"
          }
        }
      )
    );
...
export { ProgramCollectionsProvider };
