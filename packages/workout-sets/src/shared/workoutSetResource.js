...
const resource = defineCrudResource({
  ...
  workoutExerciseId: {
    ...
    required: true,
    search: true,
    relation: { kind: "lookup", namespace: "workout-exercises", valueKey: "id" },
    belongsTo: "workoutExercises",
    as: "workoutExercise",
  ...
  searchSchema: {
    ...
    workoutExerciseId: { type: "id", actualField: "workout_exercise_id", filterOperator: "=" },
    workoutExerciseIds: { type: "array", actualField: "workout_exercise_id", filterOperator: "in" },
