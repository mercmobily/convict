...
function registerRoutes(
  ...
  router.register(
    ...
    async function (request, reply) {
      ...
      const response = await request.executeAction({
        actionId: "crud.instance_progression_entries.list",
        input: listInput
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.instance_progression_entries.view",
        input: {
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.instance_progression_entries.create",
        input: {
          ...(request.input.body || {})
        }
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.instance_progression_entries.update",
        input: {
          recordId: request.input.params.recordId,
          ...(request.input.body || {})
        }
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.instance_progression_entries.delete",
        input: {
          recordId: request.input.params.recordId
        }
      });
