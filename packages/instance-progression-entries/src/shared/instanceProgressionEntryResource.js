...
const resource = defineCrudResource({
  namespace: "instance_progression_entries",
  tableName: "instance_progression_entries",
  schema: {
  userId: {
    type: "id",
    required: true,
  ...
  sourceProgressionEntryId: {
    type: "id",
    nullable: true,
    search: true,
    relation: { kind: "lookup", namespace: "progression-entries", valueKey: "id" },
    belongsTo: "progressionEntries",
    as: "sourceProgressionEntry",
    ui: { formControl: "autocomplete" },
    operations: {
      output: { required: true },
  ...
  searchSchema: {
    ...
    sourceProgressionEntryId: { type: "id", actualField: "source_progression_entry_id", filterOperator: "=" },
    sourceProgressionEntryIds: { type: "array", actualField: "source_progression_entry_id", filterOperator: "in" },
    ...
    q: { type: "string", oneOf: ["stepLabel","instructionText","measurementUnit","sourceRef"], filterOperator: "like", splitBy: " ", matchAll: true },
  },
